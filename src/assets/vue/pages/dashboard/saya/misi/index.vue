      ...
      <!-- <template v-slot:additional>
        ...
        >
          <f7-row>
            <f7-col
              :width="50"
              @click.native="$f7router.navigate('/misi/my')"
            >
            ...
            <f7-col
              :width="50"
              @click="$f7router.navigate('/misi/create')"
            >
              <p class="text-center text-primary">
                Buat Baru
              </p>
        ...
        >
          <div class="item-inner">
            <div class="item-title-row">
              ...
              <small>
                <f7-chip
                  v-if="data.submitted_at && !data.published_at"
                  :text="'Submitted'"
                />
                <f7-chip
                  v-if="!data.submitted_at"
                  :text="'Draft'"
                />
              </small>
            </div>
...
export default {
  ...
  methods: {
    ...
    onSelected(selected) {
      this.$f7router.navigate('/misi/' + selected.id)
    }
  }
}
</script>